  ...
  return (
    ...
    <div className="row flex items-center justify-center">
      <div className="col-6 mt-12 mb-8 border-koyumavis border-1 bg-mavis h-96 w-2/4 flex flex-col items-center justify-center shadow-2xl">
          <h1 className='font-bold text-white text-3xl mb-4' >Login</h1>
          ...
          <button type="button" onClick={handleClick} className="text-white mt-4 bg-koyumavis hover:bg-koyumavis focus:outline-none focus:ring-4 focus:koyumavis font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-koyumavis dark:hover:bg-koyumavis dark:focus:koyumavis dark:bg-koyumavis">Giris Yap</button>
      </div>
    </div>
    <Footer/>
    </div>
